...
const { LOGIN_ERROR, LOGIN_SUCCESS, EMAIL_VERIFY_REG, REGISTER_ERROR, REGISTER_SUCCESS } = require('../tools/enum');
...
const login = async (req, res, next) => {
    try {
        ...
        const option = email_reg.test(user_email) ? { email: user_email } : { username: user_email };
